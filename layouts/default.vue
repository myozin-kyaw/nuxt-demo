<template>
  <div>
    <nav class="bg-white shadow px-4 flex items-center gap-8">
      <div class="py-4">
        <svg
          width="35"
          height="35"
      ...
      <div>
        <NuxtLink
          to="/"
          class="text-sm font-medium text-gray-900 border-b-2 py-6"
        >
          Dashboard
        </NuxtLink>
      </div>
      <div>
        <NuxtLink
          to="/products"
          class="text-sm font-medium text-gray-900 py-6"
        >
          Products
        </NuxtLink>
      </div>
